...
## Le fil — ordre des incréments, état au 24 août 2026 au matin
...
**Deux trous relevés le 21 août 2026 ; le premier est fermé, le second tient.** Le **premier** — la
...
reste **ouvert, tel quel** : le titre du chapitre « Jalon 2 (v0.2) » est resté en arrière depuis que le
jalon 1 vise 1.0.0. Non traité, délibérément — c'est un geste du chef de projet. Énoncé d'origine
conservé ci-dessous.
...
ligne 12 ou 13, dans un sens ou dans l'autre, jamais en passant. (Renvoi recalé le 29 août 2026 par
l'insertion de la ligne 11 : il visait les lignes 11 et 12, devenues 12 et 13.)
