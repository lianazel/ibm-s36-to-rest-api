...
- **[W59]** **`.statut.refuse` porte un `padding-right` en doublon exact** de celui que `.statut` pose
...
- **[W60]** **Deux renvois « l. NNN » faux à la naissance, au commit qui rembourse [W46].** Les deux
...
- **[W61]** **Le commentaire de `.about` est faux pour moitié** : il annonce un filet de séparation
