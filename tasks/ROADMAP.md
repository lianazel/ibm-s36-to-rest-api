...
## Le fil — ordre des incréments, état au 3 septembre 2026
...
- **[W67]** **Playwright est hors de la liste d'interdits.** Les outils MCP du navigateur
...
- **[W68]** **`/land` prescrit un `git merge` que la liste d'interdits refuse** depuis le 2 septembre
